...
(define your-mama 'fat)
; expect your-mama
your-mama
; expect fat

(define (please-give-me-an-A bribe-amount)
  (cond
  ((< bribe-amount 10) 'no)
  (else 'ok)))
(please-give-me-an-A 40)
; expect ok
...
(define your-mama-likes #t)
;expect your-mama-likes
(define other-dudes #t)
; expect other-dudes
(define your-daddy #f)
; expect your-daddy

(and your-mama-likes your-daddy)
;expect #f
(and your-mama-likes other-dudes)
; expect #t

(or 3 (/ 1 0))
; expect 3

(and True (or False your-daddy) (/ 1 0))
; expect #f
